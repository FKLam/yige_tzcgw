...
util.tomedia = function(e) {
    return app.siteInfo.siteroot + "/attachment/" + e;
};
...
function getSign(e, t, a) {
    ...
    if (s || t && t.sign) {
        ...
        for (var c = 0; c < i.length; c++) {
            if (i[c] && i[c].name && i[c].value) {
                f += i[c].name + "=" + i[c].value;
                if (c < i.length - 1) {
                    f += "&";
                }
            }
...
util.request = function(e) {
    ...
    e.showLoading = typeof e.showLoading != "undefined" ? e.showLoading : true;
...
util.navigateBack = function(e) {
    ...
    wx.navigateBack({
        ...
        fail: function t(a) {
            typeof e.fail == "function" && e.function(a);
        },
        complete: function t() {
